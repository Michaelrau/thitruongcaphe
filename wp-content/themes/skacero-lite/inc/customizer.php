...
// Front Page Settings SECTION
		...
		$wp_customize->add_control(			
				...
				array(
					...
					'description' =>  __( 'Enable / Disable the Sidebar Widget in the Home Page. <a href="http://www.icynets.com/skacero-theme/" target="_blank">VIEW DOCUMENTATION</a>', 'skacero-pro' ),
		...
		$wp_customize->add_control(				
				...
				array(
					...
					'description' =>  __( 'Enable / Disable the Home Page Post Slider. <a href="http://wpthemes.icynets.com/skacero/" target="_blank">VIEW DEMO</a>. To add Slider Widget, go to Appearance > Widgets then add Skacero: Home Page Post Slider to the Home Page: Slider Area. Repeat step to add Skacero: Home Page 4 Column to Home Page: 4 Column Area. <a href="http://www.icynets.com/skacero-theme/" target="_blank">VIEW DOCUMENTATION</a>', 'skacero-pro' ),
					'section' => 'frontpage_settings',
					'type' => 'radio',
					'choices' 	=> array(
						'on' 	=> __( 'Enable', 'skacero-pro' ),
		...
		$wp_customize->add_control(	
			new Customizer_Radio_Image_Control(
				...
				'footer_column_widgets', array(
					...
					'description' =>  __( 'Select the number of Widget Columns to display in the Footer area. To add widgets go to Appearance > Widgets, then add widgets to the columns. <a href="http://wpthemes.icynets.com/skacero/" target="_blank">VIEW DEMO</a>', 'skacero-pro' ),
					'section' => 'footer_area',
					'choices' => array(
...
if (! function_exists('skacero_pro_theme_option') ){
	...
	//if ( get_theme_mod( 'theme_by' ) != 'off' ) {
		...
		<div class="col-md-6 float-r" style="text-align: right">
			<?php printf( esc_html__( 'Theme: %1$s by %2$s', 'skacero-pro' ), '<a href="http://www.icynets.com/skacero-theme/" target="_blank">Skacero</a>', '<a href="http://www.icynets.com/" target="_blank">icyNETS</a>' ); ?>
		</div>
	<?php 
	//}
	}
