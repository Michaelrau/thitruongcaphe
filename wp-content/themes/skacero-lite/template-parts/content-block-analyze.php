...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'post-list clear' ); ?>>	
	<div class="block-analyze">
	    ...
	    <?php } else {?>
	    	<div class="small-image">
	        	<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><img width="60" height="60" alt="" src="<?php echo bloginfo('template_url') . '/images/default/analyze.jpg'?>" sizes="(max-width:220px) 100vw, 220px" /></a>
	    	</div>
	    <?php }?>
