		...
		<div id="primary-top" class="top-content-area">
			...
			<div id="left-top-content-area" class="left-top-content-area">
				<?php			
					...
					$video_category = get_category_by_slug( 'tin-tuc-video' );
					$query = array(
					    "category__not_in" => array( $bgtt_category->term_id, $cn_category->term_id, $ptkt_category->term_id, $video_category->term_id  ),
						'posts_per_page' =>  16
					);
					query_posts( $query );			
					// The Query
