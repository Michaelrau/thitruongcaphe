		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="site-map">
				...
				<ul class="menu-bottom .w-1000 clearfix">
					...
					<li alias="bang-gia-truc-tuyen" class="item">
						<a href="<?php echo get_home_url() . '/ban-gia-truc-tuyen'?>">Bảng giá trực tuyến</a>
					</li>
			...
			<div class="site-info">
				<div class="container">
					...
					<div class="footer-info footer-center">						
						...
						<div class="hosting">Hosting service: <a href="https://emsa-technology.com">EMSA TECHNOLOGY</a></div>						
					</div >					
					<div class="footer-info footer-right">
						<p>Liên hệ tác giả / quảng cáo</p>
						<p>Đường dây nóng: 0983.718.338 | 01234.808.818
					</div>
				</div>
			</div><!-- .site-info -->
